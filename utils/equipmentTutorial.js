...
export function runEquipmentTutorial(scene) {
    ...
    const steps = [
        ...
        { anchor: { x: 430, y: 22 },
          show: T("That gauge up top is your spores — part fungal currency, part fuel. They build up over time; some things spend them, and merchants will pay for them.",
                  "Ten ukazatel nahoře jsou tvoje spóry — napůl houbová měna, napůl palivo. Postupně přibývají; něco je spotřebuje a kupci ti je proplatí.") },
        { anchor: { x: 50, y: 50 },
