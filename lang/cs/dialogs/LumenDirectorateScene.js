/**
 * Czech dialog translations for LumenDirectorateScene
 * Speaker: Verrik the Gardener (Verrik Zahradník)
 */
export default {
    _speakers: {
    ...
    gardener_role: {
        text: "Pěstuji. Stěny, chodníky, živé ploty — to všechno žije, víte. Direktoriát nevěří v mrtvou architekturu. Každý povrch by měl dýchat, měl by růst.\n\nJsem nízko na liáně, abych tak řekl. Ale věci slyším. Rostliny jsou dobří posluchači, a já taky.",
        options: {
    ...
    gardener_rumors: {
        text: "Ach, to a ono. Direktoriát je v poslední době neklidný. Něco ohledně zapečetění Vaječné katedrály — to je znepokojilo. Sledovali to místo léta, čekali na líhnutí.\n\nA v poslední době je tu víc ruchu než obvykle. Lidé chodí nahoru za Korektorem úhlů. To nikdy není běžná návštěva.",
        options: {
    ...
    gardener_angle_corrector: {
        text: "Korektor úhlů? To je... no, titul i jméno v jednom. Nikdo nezná jejich skutečné jméno, nebo jestli vůbec nějaké mají. Starají se o delikátnější záležitosti direktoriátu — kultivační dohled, katedrální styčná osoba, takové věci.\n\nPokud potřebujete odpovědi o čemkoliv, čeho se direktoriát dotýká, Korektor úhlů je ten, koho hledáte. Třetí patro, přes atrium. Ale nepřijímají jen tak někoho. Budete potřebovat důvod.",
        options: {
    ...
    gardener_angle_advice: {
        text: "Jedna rada — direktoriát si cení transparentnosti, nebo alespoň jejího zdání. Nepokoušejte se být chytrý. Řekněte svůj záměr přímo. Respektují přímočarost.\n\nA nesahejte na kapradiny v atriu. Koušou.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    gardener_cathedral: {
        text: "Vaječná katedrála je největší růstová událost, jakou tohle město zažilo za desítky let. Cokoliv roste uvnitř těch vajec — direktoriát tam chce být, až se to vylíhne. Monitorovali to, katalogizovali každou vibraci.\n\nKdyž Biskupka zapečetila katedrálu... řekněme, že nálada tady hodně zhoustla. Direktoriát nemá rád zavřené dveře. 'Nic skrytého,' pamatujete?",
        options: {
            who_is_the_angle_corrector: "Kdo je Korektor úhlů?",
            i_have_other_questions: "Mám další otázky."
        }
    ...
    gardener_leadership: {
        text: "Direktoriát nevede jeden člověk — je to rada. Ale ten, o kom uslyšíte nejvíc, je Korektor úhlů. Ten řeší každodenní záležitosti, citlivé věci, to, co potřebuje... zvláštní dotek.\n\nKapitánka Liris řídí operace vzdušné lodi — Verdigrace a její posádku. Je direktoriátu oddaná skrz naskrz, ale obvykle je nahoře v oblacích.",
        options: {
            who_is_the_angle_corrector: "Kdo je Korektor úhlů?",
            i_have_other_questions: "Mám další otázky."
        }
    ...
    gardener_bishop_vague: {
        text: "Smrt Biskupky... ano, to tady věcmi otřáslo. Direktoriát to navenek neukazuje, ale od té doby se konají spousty krizových porad.\n\nNeznám podrobnosti — jsem jen zahradník. Ale lidé uvnitř by mohli vědět. Korektor úhlů obzvlášť. Pokud někdo znal obchody Biskupky s direktoriátem, tak oni.\n\nTřetí patro. Jděte dovnitř, řekněte svůj záměr. Jen nečekejte snadné odpovědi.",
        options: {
            who_is_the_angle_corrector: "Kdo je Korektor úhlů?",
            i_have_other_questions: "Mám další otázky."
        }
    ...
    gardener_mushroom_result: {
        text: "",
        options: {
            what_does_it_mean: "Co to znamená?",
            ill_take_the_payment: "Vezmu si platbu."
        }
    },
