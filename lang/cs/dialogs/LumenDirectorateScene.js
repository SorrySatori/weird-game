...
export default {
    ...
    gardener_blight_bed: {
        text: `Pěstební záhon, který se zvrtl: půda ztvrdlá došeda, výhonky stočené do sebe jako pěsti. Tam, kde by měl záhon Direktorátu hučet pomalým zeleným životem, tenhle už jen slabě tiká a chladne. Něco v rovnováze města dosáhlo i sem.`,
        options: {
