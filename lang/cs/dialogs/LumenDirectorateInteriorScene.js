/**
 * Czech dialog translations for LumenDirectorateInteriorScene
 * Speaker: The Angle Corrector (Korektor úhlů)
 */
export default {
    _speakers: {
    ...
    ac_start: {
        ...
        options: {
            captain_liris_sent_me_im_here_to_join_the_director: "Chci se připojit k Direktorátu.",
            ...
            tell_me_about_the_lumen_directorate: "Řekněte mi o Lumen Directorate.",
            whats_happening_with_the_egg_cathedral: "Co se děje s Vaječnou katedrálou?",
            what_can_i_do_for_the_directorate: "Co mohu udělat pro Direktorát?",
    ...
    ac_drug_confirm: {
        text: "Korektor úhlů skloní hlavu o přesných pár stupňů a kdesi pod vámi se dá do pohybu tichá mašinerie následků. „Pak je to hotovo. Oprava bude čistá.“ Odloží kontraband stranou, už v myšlenkách jinde. „Do rána bude město uklizenější a Direktorát si zapamatuje, kdo tu vadu vynesl na světlo. To má větší cenu, než teď chápete.“ Vrátí se ke své práci, jako by právě nenařídil čtyři malé smrti.",
        options: {
    ...
    ac_not_formality: {
        text: "Nic tu není formalita. Formalita je rozklad oblečený v čistých šatech. Každá interakce v téhle budově slouží účelu — i tato.\n\nTakže. Jste připraveni na mou otázku, nebo byste raději bloudili atriem, dokud si vás nenárokují kapradiny?",
        options: {
            ask_your_question: "Ptejte se."
        }
    },
    ac_growth_test: {
        text: "Základem Direktorátu je růst. Ne jen klíčení semen nebo šíření mycelia — i když si toho hluboce ceníme. Růst jako princip. Růst jako filozofie.\n\nŘekněte mi tedy: co pro vás znamená růst? A rozmyslete si to — poznám nacvičenou odpověď stejně, jako moje kapradiny ucítí déšť.",
        options: {
            growth_is_change_becoming_something_you_werent_bef: "Růst je změna...",
            growth_is_survival_spreading_to_ensure_you_endure: "Růst je přežití..."
        }
    },
    ac_test_change: {
        text: "Změna. Bezpečná odpověď, ale ne špatná. Změna je minimální podmínka pro růst — nezbytná, ale ne dostatečná.\n\nSkála eroduje. To je změna. Ale to není růst. Růst vyžaduje směr. Záměr. Natahování-se-k.\n\nPřesto... neřekli jste 'moc' nebo 'dobytí.' To mi o vás něco říká. Direktorát přijímá vaši odpověď — prozatímně.",
        options: {
    ...
    ac_test_thorne: {
        text: "...Nesete Thorne-Stilla a přišli jste do ústředí růstové frakce. Buď jste velmi odvážní, nebo velmi hloupí.\n\nAle rozumíte něčemu, co většina ne — že růst definovaný svým protipólem je stále růst. Napětí mezi rozkladem Thorne a vaším vlastním živým vzorem vytváří něco... dynamického.\n\nTo je zajímavější odpověď, než jakou dá většina rekrutů. Direktorát vás přijímá — i vašeho pasažéra.",
        options: {
            youre_not_bothered_by_the_symbiont: "Symbiont vám nevadí?"
        }
    },
    ac_test_neme: {
        text: "Neme z Korunního bahna. Růstově orientovaný symbiont — a vlastnický. Naučil vás dobře.\n\nSpojení je kořenový systém pod viditelným lesem. Jeden strom je křehký. Tisíc stromů propojených mykorrhizou? To je síla, která vydrží.\n\nAno. Direktorát vás rád přijímá. Nositelé vybraní Neme z Korunního bahna jsou tu vždy vítáni.",
        options: {
            what_happens_now: "Co bude teď?"
        }
    },
    ac_test_instinct: {
        text: "Ha. Říkáte, že o tom nepřemýšlíte. A přesto jste tady, aktivně usilujete o rozšíření svých kontaktů, vlivu, porozumění.\n\nInstinkt je nejstarší forma růstu — ta, která předchází filozofii. Kořen se neptá, proč sahá po vodě. Prostě sahá.\n\nDirektorát má místo pro instinkt. Vlastně ho upřednostňujeme před přemýšlením. Přijato.",
        options: {
            what_happens_now: "Co bude teď?"
        }
    },
    ac_test_balance: {
        text: "...To není odpověď, kterou by Direktorát normálně uvítal. Jsme růst. Rozklad je to, čemu se stavíme.\n\nAle nemáte nepravdu. Les, který nikdy neshazuje listí, se sám udusí. Rezavý chór, přes všechno své uctívání koroze, rozumí něčemu o nutných koncích.\n\nVaši odpověď radě nebudu opakovat. Ale mezi námi — považuji ji za osvěžujícě upřímnou. Přijato.",
        options: {
            what_happens_now: "Co bude teď?"
        }
    },
    ac_test_passed: {
        text: "Teď? Jste uznáni Lumen Directorate jako spolupracovník — ne člen, ještě ne. Členství vyžaduje čas a prokázanou oddanost.\n\nAle máte přístup. Můžete se volně pohybovat těmito chodbami, konzultovat naše archivy a hledat úkoly od operativců Direktorátu.\n\nVítejte v růstu. Snažte se nezvadnout.",
        options: {
            i_have_questions: "Mám otázky."
        }
    },
    ac_about_directorate: {
        ...
        options: {
            what_about_the_rust_choir_and_the_pith_reclaimers: "A co Rezavý chór a Dřeňoví reklamátoři?",
            what_is_your_role_here: "Jaká je vaše role tady?",
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_other_factions: {
        text: "Rezavý chór uctívá entropii. Oblékají korozi do posvátných rouch a nazývají ji 'ticho mezi.' Romantický nesmysl — rozklad bez účelu je jen smrt.\n\nDřeňoví reklamátoři jsou byrokrati, kteří věří, že dokážou zvládnout chaos s dostatkem formulářů a procedur. Vzešli z trosek administrativního aparátu Ludarchů a nikdy nepřestali archivovat.\n\nSpolupracujeme s oběma, když je to nutné. Direktorát je především pragmatický.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_role: {
        text: "Koriguju úhly. Když se růst Direktorátu ohne neproduktivním směrem, narovnám ho. Když vnější síly vyvíjejí tlak — katedrála, chór, radnice — upravím naši trajektorii.\n\nKultivační dohled, diplomatická styčná osoba, hodnocení rekrutů. Každé vlákno, které vyžaduje jemný dotek, prochází touto kanceláří.\n\nJsem v podstatě zahradník Direktorátu — i když by Verrik dole při tom srovnání zježil obočí.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_bishop_inquiry: {
        ...
        options: {
            ...
            what_were_the_packages_verrik_saw: "Co byly ty balíčky, co Verrik viděl?",
            why_did_the_visits_stop: "Proč návštěvy ustaly?",
            do_you_know_who_killed_the_bishop: "Víte, kdo zabil Biskupku?",
            i_have_other_questions: "Mám další otázky."
        }
    },
    ...
    ac_bishop_stopped: {
        text: "Katedrála se zapečetila. To se stalo.\n\nBiskupka vyvolala nouzové uzavření — zamkla celou strukturu pod teologickou autoritou, kterou ani Direktorát nemohl zrušit. Žádné vysvětlení, žádná konzultace. Jeden den jsme měli plný monitorovací přístup; druhý den nic.\n\n'Nic skrytého,' a přesto Biskupka vše skryla. Dokážete si představit, jak mi to sedlo — a radě.",
        options: {
            why_did_the_bishop_seal_the_cathedral: "Proč Biskupka zapečetila katedrálu?",
            were_you_angry_with_the_bishop: "Hněvali jste se na Biskupku?",
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_bishop_seal_reason: {
        text: "Kdybych to věděl, nevedli bychom tento rozhovor.\n\nOficiální důvod byl 'teologická nouze.' Biskupka tvrdila, že něco uvnitř katedrály vyžaduje okamžitou izolaci — že líhnutí postupuje nečekaným směrem a vnější pozorování by mohlo kontaminovat proces.\n\nBiologové Direktorátu nesouhlasili. Růst nevyžaduje izolaci. Růst vyžaduje světlo, živiny, spojení. Zapečetění katedrály bylo v rozporu se vším, čemu rozumíme o kultivaci.\n\nNěco ji vyděsilo. Biskupka viděla něco uvnitř těch vajec, co ji přimělo zamknout dveře.",
        options: {
            what_do_you_think_she_saw: "Co myslíte, že viděla?",
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_bishop_what_saw: {
        text: "Mám teorie. Žádnou nesdělím... nedávnému známému.\n\nCo řeknu, je toto: růstové vzory, které naše senzory zaznamenaly před zapečetěním, byly neobvyklé. Zrychlující se, ano, ale ne uniformně. Některá vejce vykazovala aktivitu, která neodpovídala žádnému známému biologickému modelu.\n\nBiskupka se bála. A teď je Biskupka mrtvá. Kohokoliv hledáte — zvažte, že odpověď může ležet uvnitř samotné katedrály.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_bishop_anger: {
        text: "Hněvali? Ne. Hněv je plýtvání metabolickou energií.\n\nZklamání. Znepokojení. Biskupka a já jsme vybudovali něco produktivního — most mezi teologií katedrály a biologií Direktorátu. Zapečetění ten most zničilo bez konzultace.\n\nPřál jsem jí ublížení? Nikdy. Živá byla pro nás užitečnější než mrtvá. Její smrt vytvořila komplikace, které bude trvat tisíc trávení rozplést.\n\nKdokoliv Biskupku zabil, Direktorátu tím nepomohl.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_bishop_killer: {
        text: "Kdybych to věděl, ten úhel bych už opravil.\n\nSmrt Biskupky narušuje plány Direktorátu. Potřebujeme přístup do katedrály — líhnutí nemůže pokračovat bez řádného dohledu. Mrtvá Biskupka znamená teologický chaos, nástupnické spory, a katedrála zůstává zapečetěná.\n\nPodívejte se, kdo profituje z pokračujícího chaosu. Kdo prosperuje, když se instituce hroutí. Tam najdete svou odpověď — ne tady.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_cathedral: {
        text: "Vaječná katedrála je nejdůležitější růstová událost v živé paměti. Struktura, která se doslova líhne — bioluminiscenční písmo, které bliká po stěnách skořápky, více vyznání sledujících, které božstvo si ji nárokuje.\n\nDirektorát monitoroval každou vibraci, každou teplotní fluktuaci, každý sporový výdej z té struktury po desítky let. A teď je zapečetěná a my jsme slepí.\n\nProbuzení — nebo Plodění, jak tomu říkáme my — se blíží. A my nevidíme, co se děje uvnitř.",
        options: {
            what_is_the_fruiting: "Co je Plodění?",
            cant_you_find_a_way_in: "Nemůžete najít cestu dovnitř?",
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_cathedral_fruiting: {
        text: "Prorokovaný okamžik, kdy se katedrála plně vylíhne. Skořápka praskne, vnitřek se odhalí a cokoliv uvnitř rostlo, se vynoří.\n\nTeologové tomu říkají Probuzení. My tomu říkáme Plodění — protože růst má stádia a poslední stádium je vždy vznik plodu. Semene, které nese další generaci vpřed.\n\nDirektorát zamýšlí být přítomen, až k tomu dojde. Otázka je, zda tam bude kdokoliv.",
        options: {
            i_have_other_questions: "Mám další otázky."
        }
    },
    ac_cathedral_access: {
        text: "Biskupčina pečeť je teologická, ne fyzická. Naši botanici by mohli prolomit stěny za odpoledne. Ale tím bychom sjednotili každou víru ve městě proti nám — a Dřeňoví reklamátoři by nás pohřbili v žalobách na desítky let.\n\nNe. Pečeť musí být odstraněna řádně. Nástupnictvím, vyjednáváním, nebo někým, kdo může vejít, aniž by cokoliv rozbil.\n\nNěkým... jako je nezávislý vyšetřovatel, třeba.",
        options: {
    ...
    ac_sabotage_report: {
        text: "Korektor úhlů znehybní, pak vydechne cosi jako uspokojení. \"Cítil jsem to. Celá svatyně zadrženého železa naráz utichla. Rytmus města se přiklonil k životu.\" Skloní hlavu — nejblíž úkloně, co jste u nich viděli. \"Udělali jste, co Direktorát nedokázal bez války. Už nejste spolupracovník. Jste jedním z nás.\n\nVítejte, člene. 'Nic skrytého. Nic ztraceného.' — nejméně ze všeho vy.\"",
        options: {
    ...
    ac_membership_benefits: {
        text: "\"Prověrku. Každý archiv, každá kniha, každé podání, které Direktorát vede, je vám teď otevřené — a vedeme složky o všem. 'Nic skrytého' řeže do obou stran: co ostatní musí hádat, vám prostě řeknou, a Verrikovy kultivační záhony platí svým o něco lépe. Nahlédněte do složek, kdykoli honíte něco pohřbeného.\" Odmlka. \"Využijte to dobře. Nebo špatně — tak či tak to budeme mít v záznamech.\"",
        options: {
    ...
    ac_archive: {
        text: {
            ac_archive_reveal: "Předložíte svou prověrku. Asistent vytáhne štíhlou, křížově odkazovanou složku, aniž by se ptal dvakrát. \"Ta plyšová hračka? Pořízena jistým Edgarem Eskolou — sběratel, chodívá k Řvoucímu korku. Všechno je v záznamech, člene. Všechno.\" Nic skrytého, vskutku.",
    ...
    ac_seldo_name: {
        text: "Direktorát pravidelně přehodnocuje všechny členy. Hodnocení loajality, filozofické souznění, produktivita. Většina projde na první přezkum. Někteří vyžadují dva.\n\nSeldo vyžadoval tři. Ne proto, že by byl neloajální, ale protože je... komplikovaný. Jeho metody jsou oklikami. Jeho loajality jsou vrstvené. Ale tři přezkumy potvrdily, co jsem už věděl — Seldo slouží Direktorátu cele, svým vlastním zvláštním způsobem.\n\nTen název je odznak cti. Nebo varování. Záleží na úhlu pohledu.",
        options: {
            ill_go_find_seldo: "Půjdu najít Selda."
        }
    },
    ac_assignments: {
        text: "Direktorát má vždy práci pro ochotné ruce. Růst se neudržuje sám.\n\nV tuto chvíli jsou naše priority jasné: katedrála musí být zpřístupněna, smrt Biskupky musí být pochopena a rovnováha moci v tomto městě se musí přiklonit k životu spíše než ke stagnaci.\n\nPřispějte k jakémukoliv z těchto cílů a Direktorát si zapamatuje. Vždy si pamatujeme."
    },
    ...
    seldo_start: {
        text: {
            seldo_start_first: "Našli jste druhé patro. Už jen to vás staví před většinu návštěvníků — architektura Direktorátu je záměrně dezorientující. Vyřazuje netrpělivé.\n\nJsem Seldo. Seldo Třikrát-Korigovaný. Zajišťuji vztahy Direktorátu s městským administrativním aparátem — povolení, styky, občas pečlivě formulovanou hrozbu. Co vás sem přivádí?",
            ...
            seldo_start_toadlet_ready: "Ach. Tu přepravní nádobu poznávám. Prosím držte ji pod úrovní stolu — Direktorát má okna a okna mají názory. Máte mé Chronobřečkové Ropušátko?",
    ...
    seldo_name: {
        text: "Tři přezkumy. Třikrát interní auditoři Direktorátu rozpitvali mé loajality, mé metody, mé kontakty. Třikrát debatovali, zda jsem přínos, nebo přítěž.\n\nTřikrát dospěli k závěru, že jsem... přijatelný. Po svém.\n\nTitul má být známkou důvěry. Ale mezi námi — je to také připomínka, že Direktorát vždy sleduje. To mi přijde motivující.",
        options: {
            i_have_other_questions: "Mám další otázky.",
        }
    },
    ...
    seldo_embarrassment: {
        text: "Vy nerozumíte politice Direktorátu. 'Nic skrytého. Nic ztraceného' — a růst znamená jít vpřed, aniž byste hleděli dopředu. Proroctví je doména Rezavého chóru — uctívání entropie převlečené za užitečnost.\n\nOperativec Direktorátu viděn, jak dráží prorockou ropuchu? Rada by svolala mimořádné zasedání. Přežil jsem tři přezkumy loajality. Nemám v úmyslu zvát čtvrtý kvůli obojživelníkovi.\n\nPomůžete mi, nebo mám najít někoho méně zvědavého?",
        options: {
    ...
    seldo_auction_remind: {
        text: "Aukční hala na Voxmarketu. Chronobřečkové Ropušátko. Nezmiňujte mé jméno. Rozpočet kolem 80 dinárů — ale buďte připraveni přechytračit konkurenci.\n\nKlíč od Radnice čeká na Ropušátko. Tak zní dohoda.",
        options: {
