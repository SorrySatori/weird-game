/**
 * English journal entry translations — keyed by journal entry ID
 * Each entry has: title, description
 */
export default {
    journal: {
        obazoba_cult: {
        ...
        upper_morkezela: {
            ...
            description: 'They call it a city, but Upper Morkezela was never fully alive. It breathes, though — something does. The streets are grown, not built.',
        },
        fungal_apprentice: {
            title: 'Fungal Apprentice',
            description: 'As the newest apprentice to Fungal Master Thaal, I have much to learn about the world of spores and mycelium.',
        },
        fungal_master: {
            title: 'Fungal Master Thaal',
            description: 'The eccentric Fungal Master Thaal is known for his vast knowledge of spores and fungi.',
        },
        growthDecay: {
        ...
        bishop_bruising: {
            title: 'Neural Trauma',
            description: "The Bishop's body shows signs of neural trauma - bruising at the temples where dream interface devices connect.",
        },
        bishop_cartridge: {
            title: 'The Cardinal Feast',
            description: 'The Bishop was using a dream cartridge called "The Cardinal Feast" when she died.',
        },
        bishop_helmet: {
        ...
        bishop_journal: {
            ...
            description: 'The Bishop\'s journal contains a disturbing note: "The city no longer hears me. Perhaps the dreams will."',
        },
        bishop_memo: {
            title: 'Townhall Memo',
            description: 'A memo from the Bishop describes a disturbing encounter with what sounds like a doppelgänger.',
        },
        bishop_dissection: {
            title: 'Unusual Fungal Growth',
            description: "During my examination of the Bishop's body, I discovered an unusual fungal growth.",
        },
        neme_symbiont_discovered: {
            title: 'Neme of the Crownmire',
            description: "I discovered a symbiont living inside the dead Bishop's body.",
        },
        neme_symbiont_accepted: {
            title: 'Bonded with Neme',
            description: 'I accepted the symbiont Neme of the Crownmire. Its tendrils have nestled beneath my skin.',
        },
        neme_symbiont_declined: {
            title: 'Rejected Neme',
            description: "I chose not to accept the symbiont that emerged from the Bishop's body.",
        },
        bishop_berries: {
            title: 'Spiced Sulkberries',
            description: 'The Bishop had been eating Sulkberries shortly before her death.',
        },
        ...
        delta_fungal_bridge: {
            ...
            description: 'I planted spores in the sediment between the delta islands.',
        },
        redmass_encountered: {
            title: 'The Living Redmass',
            description: 'On the island at Echo Drain Delta, I found a living redmass — a crystalline metal organism that can speak.',
        },
        redmass_spared: {
            title: 'Spared the Redmass',
            description: 'I chose not to take the living redmass by force.',
        },
        redmass_collected_forced: {
            title: 'Tore the Redmass',
            description: 'Tore the living redmass from the island despite its pleas.',
        },
        redmass_collected_voluntary: {
            title: 'Received Redmass Willingly',
            description: 'The living redmass on the island gave me a piece of itself willingly.',
        },
        symbiont_ulvarex_accepted: {
            title: 'Accepted Ulvarex the Borrowed Horizon',
            description: "At the harbor, I encountered a symbiont trapped in the water's reflection.",
        },
        symbiont_ulvarex_declined: {
            title: 'Declined Ulvarex the Borrowed Horizon',
            description: 'I encountered a strange symbiont in the harbor water.',
        },
        scraper_building: {
            title: 'The Scraper',
            description: 'The imposing structure known as "The Scraper" rises above the city.',
        },
        lift_mother_meeting: {
        ...
        rust_choir_info: {
            ...
            description: 'The Rust Choir reside on the upper floors of the Scraper building.',
        },
        scraper_backyard: {
            title: 'Scraper Backyard',
            description: 'Behind the Scraper building lies an overgrown yard.',
        },
        elphi_told_bishop_dead: {
            title: "Dr. Elphi Learns of the Bishop's Death",
            description: 'I told Dr. Elphi that the Bishop is dead.',
        },
        elphi_dream_kill_theory: {
            title: 'Death by Recursive Experience',
            description: 'Dr. Elphi explained that dream helmets have neural failsafes.',
        },
        elphi_bruising_analysis: {
            title: "Dr. Elphi's Analysis: Neural Bruising",
            description: 'Dr. Elphi confirmed that the bruising is consistent with a neural feedback surge.',
        },
        elphi_cartridge_analysis: {
            title: "Dr. Elphi's Analysis: The Cardinal Feast",
            description: 'Dr. Elphi examined The Cardinal Feast cartridge.',
        },
        ...
        elphi_journal_analysis: {
            ...
            description: "Dr. Elphi interpreted the Bishop's journal entry.",
        },
        elphi_dissection_analysis: {
            title: "Dr. Elphi's Analysis: The Fungal Growth",
            description: 'Dr. Elphi identified the fungal growth as a symbiont.',
        },
        elphi_berries_analysis: {
            title: "Dr. Elphi's Analysis: Spiced Sulkberries",
            description: 'Dr. Elphi confirmed the Sulkberries are a spiced variety.',
        },
        elphi_lumen_lead: {
            title: 'Investigation Lead: The Lumen Directorate',
            description: 'Dr. Elphi pointed me toward the Lumen Directorate.',
        },
        ...
        phor_calesta: {
            ...
            description: 'I have met another strange person. An archaeologist specializing in the study of dead gods.',
        },
        kloor_venn_meeting: {
            title: 'Kloor Venn - Pharmaceutical Entrepreneur',
            description: 'In Voxmarket, I encountered Kloor Venn.',
        },
        kloor_vestigel_exchange: {
            title: 'Vestigel Exchange with Kloor',
            description: 'I traded the vestigel I acquired from Edgar Eskola to Kloor Venn.',
        },
        ...
        forgotten_elevator_button_available: {
            ...
            description: 'Zerren has added a strange item to her inventory.',
        },
        rust_feast_completed_full: {
            title: 'Rust Feast Prepared',
            description: 'Ravla prepared the Rust Feast with the living redmass I brought.',
        },
        rust_feast_completed_shard: {
            title: 'Rust Feast Prepared (Meager)',
            description: 'Ravla prepared the Rust Feast with the redmass shard I brought.',
        },
        ...
        rust_domain_arrival: {
            ...
            description: 'I have reached the upper floors of the Scraper.',
        },
        rust_choir_joined: {
            title: 'Welcomed into the Rust Choir',
            description: 'I delivered the Rust Feast to Brukk.',
        },
        rust_choir_rejected: {
        ...
        met_angle_corrector: {
            ...
            description: 'Met the enigmatic Angle Corrector on the third floor.',
        },
        ac_growth_test_passed: {
            title: "Passed the Angle Corrector's Test",
            description: 'The Angle Corrector tested my understanding of growth.',
        },
        ...
        edgar_aspiration: {
            title: "Edgar's Literary Aspirations",
            description: 'Edgar Eskola expressed his desire to write a book.',
        },
        edgar_book_quest_start: {
            title: 'A Promise to a Writer',
            description: 'I offered to help Edgar Eskola write his book.',
        },
        edgar_vestigel_received: {
            title: "The Writer's Token",
            description: 'Today I acquired one of the three vestigels from Edgar Eskola.',
        },
        edgar_vestigel_negotiation: {
            title: 'A Deal with Edgar',
            description: 'Edgar Eskola agreed to trade his vestigel in exchange for help.',
        },
        ...
        magnekin_hopsalot_conversion: {
            ...
            description: 'I have converted Magnekin to the faith of Maltimus Hopsalot.',
        },
        magnekin_hopsalot_church: {
            title: 'Maltimus Hopsalot Church',
            description: 'Lagerlandia is a mythical land where beer flows like rivers.',
        },
        magnekin_reveal: {
            title: 'Magnekin',
            description: 'I have discovered that creature called Magnekin is not a single being.',
        },
        magnekin_destroyed: {
            title: 'The Destruction of Magnekin',
            description: 'I destroyed Magnekin.',
        },
